 ...
 * @author Gajendra
 */
public class AhistoryClick extends javax.swing.JFrame {
    String A_id2;


    /**
     * Creates new form AhistoryClick
     */
    public AhistoryClick(String id) {
       A_id2=id;
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AhistoryClick.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AhistoryClick(null).setVisible(true);
            }
        });
    }
